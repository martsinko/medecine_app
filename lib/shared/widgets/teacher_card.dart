...
import '../../features/home/presentation/widgets/info_container.dart';
...
class TeacherCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final newRating = rating == 5 ? rating.toInt().toString() : rating.toString();
    return Container(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 6,),
                      InfoContainer(title: comments.toString(), icon: Icons.comment_outlined),
                      Spacer(),
                      SmallButton(
                        onTap: (){},
